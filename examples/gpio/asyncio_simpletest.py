...
async def main():  # Don't forget the async!
    led_task = asyncio.create_task(blink(board.GP29, 0.25, 10))
...
async def main():
    # pylint: disable=function-redefined
    led1_task = asyncio.create_task(blink(board.GP27, 0.25, 10))
    led2_task = asyncio.create_task(blink(board.GP28, 0.1, 20))
